        ...
        <div className="flex flex-col justify-center">
          <div className="container mx-auto px-5 max-w-7xl">
            <div className="mx-auto max-w-screen-xl text-center flex flex-col items-center justify-center">
              ...
              <p class="text-base mb-10 sm:mb-16 font-medium w-fit text-violet-700 p-4 px-6 bg-white rounded-full border border-violet-100 shadow-lg shadow-violet-300/20">
